...
/**
 * UnzerCw_UnzerInstallment
 *
 * This class defines is the module class for the
 * payment method "UnzerInstallment".
 *
 * @author customweb GmbH
 */
class UnzerCw_UnzerInstallment extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_unzerinstallment';
	public $paymentMethodName = 'unzerinstallment';
	public $paymentMethodDisplayName = 'Unzer Instalment';
		...
		$fields = array(
			0 => array(
				'name' => 'EFFECTIVE_INTEREST_RATE',
 				'label' => $this->l("Applied Interest Rate"),
 				'desc' => $this->l("The interest rate in percent that you enter here will be applied onto the
						instalment. The rate must be above the amount that you have agreed up on with .
					"),
 				'default' => '5.99',
 				'type' => 'text',
 			),
...
$fields = array_merge($this->getFormFieldsInner(), $fields);
	...
	public function installMethodSpecificConfigurations(){
		self::loadClasses();
		$this->getConfigApi()->updateConfigurationValue('EFFECTIVE_INTEREST_RATE', '5.99');
	...
	public function uninstallMethodSpecificConfigurations(){
		self::loadClasses();
		$this->getConfigApi()->removeConfigurationValue('EFFECTIVE_INTEREST_RATE');
