 ...
 */
class UnzerCw_Sofortueberweisung extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_sofortueberweisung';
	public $paymentMethodName = 'sofortueberweisung';
	public $paymentMethodDisplayName = 'SOFORT';
