 ...
 */
class UnzerCw_Prepayment extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_prepayment';
	public $paymentMethodName = 'prepayment';
	public $paymentMethodDisplayName = 'Prepayment';
