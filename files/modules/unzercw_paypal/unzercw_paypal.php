 ...
 */
class UnzerCw_PayPal extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_paypal';
	public $paymentMethodName = 'paypal';
	public $paymentMethodDisplayName = 'PayPal';
