 ...
 */
class UnzerCw_Alipay extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_alipay';
	public $paymentMethodName = 'alipay';
	public $paymentMethodDisplayName = 'Alipay';
