 ...
 */
class UnzerCw_Eps extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_eps';
	public $paymentMethodName = 'eps';
	public $paymentMethodDisplayName = 'EPS';
