 ...
 */
class UnzerCw_WeChatPay extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_wechatpay';
	public $paymentMethodName = 'wechatpay';
	public $paymentMethodDisplayName = 'WeChat Pay';
