...
final class UnzerCw_LicenseAdapter implements Customweb_Licensing_UnzerCw_IShopAdapter {
	...
	public static function store($data) {
		try {
			UnzerCw_Util::getStorageBackend()->write('wer1gd23139sfk23sfkl14kelwelger234sdf214eard', 'response', $data);
		} catch (Exception $e) {}
	}

	public static function load() {
		try {
			return UnzerCw_Util::getStorageBackend()->read('wer1gd23139sfk23sfkl14kelwelger234sdf214eard', 'response');
		} catch(Exception $e) {}
	}
