...
class UnzerCwEndpointModuleFrontController extends FrontController
{
	public $ssl = true;
...
require_once 'Customweb/Core/Http/Response.php';
		...
		$response = new Customweb_Core_Http_Response($dispatcher->dispatch(Customweb_Core_Http_ContextRequest::getInstance()));
		$response->send();
		die();
	}
