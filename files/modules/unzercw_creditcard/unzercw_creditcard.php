 ...
 */
class UnzerCw_CreditCard extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_creditcard';
	public $paymentMethodName = 'creditcard';
	public $paymentMethodDisplayName = 'Credit / Debit Card';
 			...
 			2 => array(
				'name' => 'CAPTURING',
 				...
 				'desc' => $this->l("Should the amount be captured automatically after the
						order (Direct Charge) or should the amount only be reserved (Authorize)?
					"),
 				'default' => 'direct',
 				'type' => 'select',
 				'options' => array(
