 ...
 */
class UnzerCw_IDeal extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_ideal';
	public $paymentMethodName = 'ideal';
	public $paymentMethodDisplayName = 'iDEAL';
