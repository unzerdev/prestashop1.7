 ...
 */
class UnzerCw_Giropay extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_giropay';
	public $paymentMethodName = 'giropay';
	public $paymentMethodDisplayName = 'giropay';
