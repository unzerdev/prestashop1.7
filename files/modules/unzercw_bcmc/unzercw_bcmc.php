 ...
 */
class UnzerCw_Bcmc extends PaymentModule implements UnzerCw_IPaymentMethod {
	/**
	 *
	...
	public $name = 'unzercw_bcmc';
	public $paymentMethodName = 'bcmc';
	public $paymentMethodDisplayName = 'Bancontact';
